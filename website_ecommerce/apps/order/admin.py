...
def admin_order_shipped(modeladmin, request, queryset):
    for order in queryset:
        ...
        send_mail('Order Sent', 'Your order has been sent!', 'noreply@icadgadgets.com', ['muhammadirsyadibrahim21@gmail.com', order.email], fail_silently=False, html_message=html)
    return
